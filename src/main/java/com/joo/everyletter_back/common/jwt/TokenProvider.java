...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 10;   // 10초
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60;  // 600초
    ...
    public TokenDto generateTokenDto(Authentication authentication) {
        ...
        String accessToken = Jwts.builder()
                ...
                .signWith(key, SignatureAlgorithm.HS512)    // header "alg": "HS256"
                .compact();
