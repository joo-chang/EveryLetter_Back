...
public class FileService {
    ...
    private Optional<File> convert(MultipartFile file) throws IOException {
        File convertFile = new File(System.getProperty("/Users/joochang/document/img") + "/" + file.getOriginalFilename());
    ...
    public String fileupload(MultipartFile file) {
        try {
            ...
            String fileUrl = String.format("https://%s.s3.%s.amazonaws.com/%s", bucket, location, fileName);
